...
import { isValidCode } from "@/components/game/game-config";

/*
  Gate de código previo a la modal de "Las 33 Leyes Universales".

  Pide un código; si es válido (isValidCode, ver game-config.ts) llama a onUnlock
  (el padre abre la CardUnicaModal). Código incorrecto → error + sacudida.
  Cierra por backdrop, botón X o Escape. Bloquea el scroll del body.

  Reusa el look del paso 1 de CodeModal (beam-card, neón).
*/
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-7">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  aria-describedby={error ? "unlock-code-error" : undefined}
                  className={[
