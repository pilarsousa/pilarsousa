...
import { VENTAS_WHATSAPP_EQUIPO_URL } from "@/lib/links";
      ...
      <Container>
        <Reveal delay={0.1}>
          <div className="mx-auto flex max-w-3xl flex-col items-center gap-4 rounded-2xl border border-cyan/20 bg-[radial-gradient(90%_120%_at_0%_0%,rgba(40,191,241,0.12),transparent_62%),linear-gradient(180deg,rgba(12,12,16,0.96),rgba(0,0,0,0.92))] px-6 py-7 text-center shadow-[0_22px_55px_-34px_rgba(40,191,241,0.8)] sm:px-8 sm:py-8 md:flex-row md:justify-center md:gap-8 md:text-left">
            <h2 className="max-w-xs font-display text-lg font-semibold leading-snug text-foreground sm:max-w-sm sm:text-xl">
              Tengo dudas, quiero hablar con el{" "}
              <span className="bg-clip-text text-transparent bg-[length:200%_auto] animate-neon-drift bg-[linear-gradient(110deg,#28bff1_0%,#aef0fe_38%,#ffffff_55%,#aef0fe_72%,#28bff1_100%)]">
                equipo de Pilar
              </span>
            </h2>
