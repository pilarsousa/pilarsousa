...
/*
  ...
  Cualifica a la audiencia con 4 perfiles a los que el entrenamiento les sirve.
  Copy PLACEHOLDER — editá cada item con el mensaje real. Mismo look de cards
  neón que el resto de la landing.
*/
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {PERFILES.map((text, i) => (
              <Reveal key={i} delay={0.1 + i * 0.1}>
                <article className="flex h-full items-start gap-4 rounded-sm border border-cyan/20 bg-background/40 p-6 transition-all duration-500 hover:border-cyan/55 hover:shadow-[0_0_32px_rgba(40,191,241,0.14)]">
