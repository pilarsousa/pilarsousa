...
/*
  ...
  Comparte tipografía y paleta con Volver al Origen a propósito: envuelve todo en
  .mo-scope, la misma clase que usa Volver al Origen para redefinir los tokens
  semánticos (--color-background, --font-display, …) a su versión neón/cyberpunk
  (Zen Dots + Jost). Ver el bloque .mo-scope en globals.css.

  A diferencia de Volver al Origen, esta landing NO monta la AnnouncementBar ni el
